...
return {
	...
	opts = function()
		...
		set_highlights({
			{ group = "RenderMarkdownH1Bg", value = { fg = "#c678dd" } },
			{ group = "RenderMarkdownH2Bg", value = { fg = "#e5c07b" } },
			{ group = "RenderMarkdownH3Bg", value = { fg = "#61afef" } },
			{ group = "RenderMarkdownH4Bg", value = { fg = "#98c379" } },
			{ group = "RenderMarkdownH5Bg", value = { fg = "#56b6c2" } },
			{ group = "RenderMarkdownH6Bg", value = { fg = "#e06c75" } },
			{ group = "RenderMarkdownInlineHighlight", value = { fg = "#e5c07b", bold = true } },
		})

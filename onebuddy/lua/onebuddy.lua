...
Group.new('SignColumn',   c.mono_3,       c.syntax_bg,     no)
...
Group.new('TabLineSel',   c.mono_4,       c.hue_2,         no)
...
Group.new('htmlh1',             c.hue_6,  c.none,     no)
...
Group.new('vimfunc',         c.hue_1,  c.none,  no)
Group.new('vimfuncname',     c.hue_1,  c.none,  no)
Group.new('vimnotfunc',      c.hue_3,  c.none,  no)
Group.new('vimlet',          c.hue_3,  c.none,  no)
Group.new('vimCommentTitle', c.mono_3, c.none,  b)
Group.new('vimFunction',     c.hue_1,  c.none,  no)
Group.new('vimoper',         c.hue_3,  c.none,  no)
...
Group.new('vimfuncvar',      c.mono_1, c.none,  no)
Group.new('vimbracket',      c.none,   c.none,  no)
Group.new('vimiscommand',    c.mono_1, c.none,  no)
Group.new('vimmap',          c.hue_3, c.none,  no)
Group.new('vimmaplhs',       c.hue_6_2, c.none,  no)

-- VimWiki
Group.new('vimwikibold',       c.mono_1, c.none,  b)
Group.new('VimwikiH1Folding',  c.none, c.none,  no)

-- TaskWiki
Group.new('TaskWikiTaskPriority', c.hue_5, c.none,  no)
...
Group.new('TSFuncBuiltin',        c.hue_6_2, c.none, no)
...
Group.new('TSType',               c.hue_6_2, c.none, no)
Group.new('TSTypeBuiltin',        c.hue_3, c.none, no)
